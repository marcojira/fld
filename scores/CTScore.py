...
class CTScore(Score):
    ...
    def compute_score(self, train_feat, baseline_feat, test_feat, gen_feat, kernel_size=10000, plot=False):
        ...
        C_T_score = C_T(test_feat, Pn_labels, gen_feat, Qm_labels, train_feat, T_labels, tau = 20 / len(gen_feat))
